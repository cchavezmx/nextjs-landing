  ...
  return (
    <Fragment>
      <div className="footer">
        <div className="fa">
          <img
            src="/social/git_logo.svg"
            alt="Logo Grupo Intecsa ingenieria eléctrica"
        ...
        <div className="fb">
          <div className="footer_secction">
            <img
              src="/social/contact.svg"
              alt="Logo Grupo Intecsa ingenieria eléctrica"
              className="footer-imges"
            />
            <div>
        ...
        <div className="fc">
          ...
          <div className="footer_secction">
            <img
              src="/social/maps.svg"
              alt="Logo Grupo Intecsa ingenieria eléctrica"
              className="btn footer-imges"
              onClick={() => toggole()}
            />
            <div>
              <h5 className="footer__h5">Información de Contacto</h5>
              <p className="col-8">
                Raúl Zárate Machuca Cuevítas, 01220 Ciudad de México, CDMX
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fd">
          <div className="footer_secction">
            <div>
              <h5 className="footer__h5">Visitanos</h5>
              <iframe
                title="myMapa"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5322.527002406184!2d-99.22696839255828!3d19.38668419189787!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d201adefab9513%3A0xa5936acc13a69c0d!2sRa%C3%BAl%20Z%C3%A1rate%20Machuca%2011%2C%20Cuevitas%2C%20%C3%81lvaro%20Obreg%C3%B3n%2C%2001220%20Ciudad%20de%20M%C3%A9xico%2C%20CDMX!5e0!3m2!1ses!2smx!4v1613650539398!5m2!1ses!2smx"
                frameBorder="0"
                style={{ border: "0" }}
                allowFullScreen=""
                aria-hidden="false"
